...
do
	...
	cat test.html > $i;
	sed -i "_bak" 's/$/&<br>/g ; s/width="100%"/style="max-width:50%;"/g ; s/data-lazyload/src/g ; s#src="http://img.fox800.xyz/themes/wechat/yellow-theme/default-skin/src/img/default.jpg"##g' $i
done
